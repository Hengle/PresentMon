...
X_("msStalledOnQueueFull", "[ms]", ms_stalled_on_queue_full,,, track_queue_timers) \
X_("msWaitingOnQueueSync", "[ms]", ms_waiting_on_queue_sync,,, track_queue_timers) \
X_("msWaitingOnQueueDrain", "[ms]", ms_waiting_on_queue_drain,,, track_queue_timers) \
X_("msWaitingOnFence", "[ms]", ms_waiting_on_fence,,, track_queue_timers) \
X_("msWaitingOnFenceSubmission", "[ms]", ms_waiting_on_fence_submission,,, track_queue_timers) \
X_("msStalledOnQueueEmpty", "[ms]", ms_stalled_on_queue_empty,,, track_queue_timers) \
X_("msBetweenProducerPresents", "[ms]", ms_between_producer_presents,,, track_queue_timers) \
X_("msBetweenConsumerEvents", "[ms]", ms_between_consumer_presents,,, track_queue_timers) \
X_("msWaitingOnSyncObject", "[ms]", ms_waiting_on_sync_object,,, track_cpu_gpu_sync) \
X_("msWaitingOnQueryData", "[ms]", ms_waiting_on_query_data,,, track_cpu_gpu_sync) \
X_("msWaitingOnDrawTimeCompilation", "[ms]", ms_waiting_on_draw_time_compilation,,, track_shader_compilation) \
X_("msWaitingOnCreateTimeCompilation", "[ms]", ms_waiting_on_create_time_compilation,,, track_shader_compilation) \
X_("msInMakeResident", "[ms]", ms_in_make_resident,,, track_memory_residency) \
X_("msInPagingPackets", "[ms]", ms_in_paging_packets,,, track_memory_residency) \
...
X_("CPUBias", "", cpu_bias,,, track_powershare_bias) \
X_("GPUBias", "", gpu_bias,,, track_powershare_bias)