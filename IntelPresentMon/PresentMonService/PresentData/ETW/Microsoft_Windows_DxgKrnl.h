...
//     version:    main a2df1d5d33095018291d25567e5ac072067eacf1
//     parameters: --no_event_structs --event=AdapterAllocation::Start --event=AdapterAllocation::Stop --event=AdapterAllocation::DCStart --event=Blit::Info --event=BlitCancel::Info --event=Flip::Info --event=FlipMultiPlaneOverlay::Info --event=IndependentFlip::Info --event=HSyncDPCMultiPlane::Info --event=VSyncDPCMultiPlane::Info --event=MMIOFlip::Info --event=MMIOFlipMultiPlaneOverlay::Info --event=Present::Info --event=PresentHistory::Start --event=PresentHistory::Info --event=PresentHistoryDetailed::Start --event=QueuePacket::Start --event=QueuePacket::Start_2 --event=QueuePacket::Stop --event=VSyncDPC::Info --event=Context::DCStart --event=Context::Start --event=Context::Stop --event=HwQueue::DCStart --event=HwQueue::Start --event=NodeMetadata::Info --event=Device::DCStart --event=Device::Start --event=Device::Stop --event=DmaPacket::Start --event=DmaPacket::Info --event=MakeResident::Start --event=MakeResident::Stop --event=PagingQueuePacket::Start --event=PagingQueuePacket::Info --event=PagingQueuePacket::Stop --provider=Microsoft-Windows-DxgKrnl
#pragma once
...
// NOTE: BlitCancel needs to be added manually if etw_list run on <Win11:

// NOTE: Several events have the Present keyword on Win11.  The trace session
// will add this at runtime if running on Win11.
...
EVENT_DESCRIPTOR_DECL(HSyncDPCMultiPlane_Info       , 0x017e, 0x02, 0x11, 0x00, 0x00, 0x00e6, 0x4000000000000001)
EVENT_DESCRIPTOR_DECL(HwQueue_DCStart               , 0x01a8, 0x00, 0x11, 0x00, 0x03, 0x00ff, 0x4000000000000840)
EVENT_DESCRIPTOR_DECL(HwQueue_Start                 , 0x01a6, 0x00, 0x11, 0x00, 0x01, 0x00ff, 0x4000000000000840)
EVENT_DESCRIPTOR_DECL(IndependentFlip_Info          , 0x010a, 0x03, 0x11, 0x00, 0x00, 0x0097, 0x4000000000000001)
...
EVENT_DESCRIPTOR_DECL(MakeResident_Start            , 0x0152, 0x00, 0x11, 0x00, 0x01, 0x00b8, 0x4000000000000004)
EVENT_DESCRIPTOR_DECL(MakeResident_Stop             , 0x0153, 0x00, 0x11, 0x00, 0x02, 0x00b8, 0x4000000000000004)
EVENT_DESCRIPTOR_DECL(NodeMetadata_Info             , 0x00fa, 0x00, 0x11, 0x00, 0x00, 0x008d, 0x4000000000000001)
EVENT_DESCRIPTOR_DECL(PagingQueuePacket_Info        , 0x0144, 0x00, 0x11, 0x00, 0x00, 0x00b2, 0x4000000000000001)
EVENT_DESCRIPTOR_DECL(PagingQueuePacket_Start       , 0x0142, 0x01, 0x11, 0x00, 0x01, 0x00b2, 0x4000000000000001)
EVENT_DESCRIPTOR_DECL(PagingQueuePacket_Stop        , 0x0145, 0x00, 0x11, 0x00, 0x02, 0x00b2, 0x4000000000000001)
EVENT_DESCRIPTOR_DECL(PresentHistoryDetailed_Start  , 0x00d7, 0x02, 0x11, 0x00, 0x01, 0x007e, 0x4000000000000001)
EVENT_DESCRIPTOR_DECL(PresentHistory_Info           , 0x00ac, 0x02, 0x11, 0x00, 0x00, 0x0006, 0x4000000000000001)
EVENT_DESCRIPTOR_DECL(PresentHistory_Start          , 0x00ab, 0x02, 0x11, 0x00, 0x01, 0x0006, 0x4000000000000001)
...
EVENT_DESCRIPTOR_DECL(VSyncDPCMultiPlane_Info       , 0x0111, 0x04, 0x11, 0x00, 0x00, 0x009f, 0x4000000000000001)
...
enum class D3DDDI_MAKERESIDENT_FLAGS : uint32_t {
    CantTrimFurther = 1,
    MustSucceed = 2,
};
...
enum class VIDMM_OPERATION : uint32_t {
    VidMmOpNone = 0,
    VidMmOpRestoreSegments = 101,
    VidMmOpPurgeSegments = 102,
    VidMmOpCleanupPrimary = 103,
    VidMmOpAllocatePagingBufferResources = 104,
    VidMmOpFreePagingBufferResources = 105,
    VidMmOpReportVidMmState = 106,
    VidMmOpRunApertureCoherencyTest = 107,
    VidMmOpRunUnmapToDummyPageTest = 108,
    VidMmOpDeferredCommand = 109,
    VidMmOpSuspendMemorySegmentAccess = 110,
    VidMmOpResumeMemorySegmentAccess = 111,
    VidMmOpEvictAndFlush = 112,
    VidMmOpCommitVirtualAddressRange = 113,
    VidMmOpUncommitVirtualAddressRange = 114,
    VidMmOpDestroyVirtualAddressAllocator = 115,
    VidMmOpPageInDevice = 116,
    VidMmOpMapContextAllocation = 117,
    VidMmOpInitPagingProcessVaSpace = 118,
    VidMmOpUpdateGpuVirtualAddress = 119,
    VidMmOpFreeGpuVirtualAddress = 120,
    VidMmOpUncommitAllocGpuVa = 121,
    VidMmOpFreeVpr = 122,
    VidMmOpSuspendResumeDevice = 123,
    VidMmOpTrimOfferCommitment = 124,
    VidMmOpMoveResources = 126,
    VidMmOpInvalidateAllVirtualAddresses = 127,
    VidMmOpFreeVPRReserve = 128,
    VidMmOpOfferCHARange = 129,
    VidMmOpEnableIoMmuIsolation = 130,
    VidMmOpDisableIoMmuIsolation = 131,
    VidMmOpValidateIntegrity = 132,
    VidMmOpCloseAllocation = 200,
    VidMmOpComplexLock = 202,
    VidMmOpPinAllocation = 203,
    VidMmOpFlushPendingGpuAccess = 204,
    VidMmOpUnpinAllocation = 205,
    VidMmOpMakeResident = 206,
    VidMmOpEvict = 207,
    VidMmOpLockInAperture = 208,
    VidMmOpInitContextAllocation = 209,
    VidMmOpReclaimAllocation = 210,
    VidMmOpDiscardAllocation = 211,
    VidMmOpSetAllocationPriority = 212,
    VidMmOpEvictionTest = 213,
    VidMmOpUpdateAllocationProperty = 214,
    VidMmOpDecommitAllocation = 215,
    VidMmOpUnblockMemoryRanges = 216,
    VidMmOpEvictSystemMemoryOfferList = 1000,
    VidMmOpProcessPendingOfferList = 1001,
    VidMmOpDefragment = 1002,
};

enum class VIDMM_PAGING_QUEUE : uint32_t {
    UMD = 0,
    Default = 1,
    Evict = 2,
    Reclaim = 3,
