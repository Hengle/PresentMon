...
LRESULT CALLBACK BrowserWindowWndProc(HWND window_handle, UINT message, WPARAM w_param, LPARAM l_param)
{
    ...
    case WM_CREATE:
    {
        ...
        if (CefCommandLine::GetGlobalCommandLine()->HasSwitch("p2c-url"))
        {
            url = CefCommandLine::GetGlobalCommandLine()->GetSwitchValue("p2c-url");
        }
...
HWND CreateBrowserWindow(HINSTANCE instance_handle, int show_minimize_or_maximize)
{
    ...
    HWND hwnd = CreateWindow(
        BrowserWindowClassName, "PresentMon 2 Capture",
        WS_OVERLAPPEDWINDOW | WS_CLIPCHILDREN, CW_USEDEFAULT, CW_USEDEFAULT,
        1366, 768, nullptr, nullptr, instance_handle, nullptr
    );
