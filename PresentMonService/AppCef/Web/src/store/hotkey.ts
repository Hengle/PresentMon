...
export class HotkeyModule extends VuexModule {
  ...
  defaultBindings: Binding[] = [
    {action: HotkeyAction.ToggleCapture, combination: {key: <KeyCode>42, modifiers: [<ModifierCode>1, <ModifierCode>4]} },
    {action: HotkeyAction.CyclePreset, combination: {key: <KeyCode>47, modifiers: [<ModifierCode>1, <ModifierCode>4]} },
  ];
