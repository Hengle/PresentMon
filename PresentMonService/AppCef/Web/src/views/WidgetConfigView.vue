    ...
    <v-row class="mt-8">       
      ...
      <v-col cols="9">
        <v-row dense>
          ...
          <v-col cols="6">
            <color-picker v-model="borderColor" class="color-picker" label="Border"></color-picker>
          </v-col>
          <v-col cols="6">
            <color-picker v-model="valueTextColor" class="color-picker" label="Current Value"></color-picker>
          </v-col>
        </v-row>
      </v-col>
    </v-row>
...
export default Vue.extend({
  ...
  computed: {
    ...
    valueTextColor: {
      get(): RgbaColor { return this.graph.valueTextColor; },
      set(valueTextColor: RgbaColor) {
        Loadout.setGraphAttribute({ index: this.index, attr: 'valueTextColor', val: valueTextColor });
      },
    },
    dividerColor: {
