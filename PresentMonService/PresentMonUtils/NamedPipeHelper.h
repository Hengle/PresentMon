...
public:
    ...
    static PM_STATUS DecodeStartStreamingResponse(MemBuffer* rsp_buf, IPMSMFileName* mapfile_name);
    ...
    static PM_STATUS EncodeEnumerateAdaptersRequest(MemBuffer* rqst_buf);
