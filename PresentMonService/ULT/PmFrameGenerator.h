...
struct PMFrameTimingInformation {
  ...
  double ms_waiting_on_fence = 0.;
  double ms_waiting_on_fence_submission = 0.;
  double ms_stalled_on_queue_empty = 0.;
  double ms_between_producer_presents = 0.;
  double ms_between_consumer_presents = 0.;
  double ms_gpu_active = 0.;
  double ms_gpu_video_active = 0.;
  double ms_waiting_on_sync_object = 0.;
  double ms_waiting_on_query_data = 0.;
  double ms_waiting_on_draw_time_compilation = 0.;
  double ms_waiting_on_create_time_compilation = 0.;
  double ms_in_make_resident = 0.;
  double ms_in_paging_packets = 0.;
};
...
class PmFrameGenerator {
 public:
  struct FrameParams {
    ...
    std::optional<double> stalled_on_queue_full_ms;
    std::optional<double> stalled_on_queue_full_variation_ms;
    std::optional<double> waiting_on_queue_sync_ms;
    std::optional<double> waiting_on_queue_sync_variation_ms;
    std::optional<double> waiting_on_queue_drain_ms;
    std::optional<double> waiting_on_queue_drain_variation_ms;
    std::optional<double> waiting_on_fence_ms;
    std::optional<double> waiting_on_fence_variation_ms;
    std::optional<double> waiting_on_fence_submission_ms;
    std::optional<double> waiting_on_fence_submission_variation_ms;
    std::optional<double> stalled_on_queue_empty_ms;
    std::optional<double> stalled_on_queue_empty_variation_ms;
    std::optional<double> between_producer_presents_ms;
    std::optional<double> between_producer_presents_variation_ms;
    std::optional<double> between_consumer_presents_ms;
    std::optional<double> between_consumer_presents_variation_ms;
    std::optional<double> waiting_on_sync_object_ms;
    std::optional<double> waiting_on_sync_object_variation_ms;
    std::optional<double> waiting_on_query_data_ms;
    std::optional<double> waiting_on_query_data_variation_ms;
    std::optional<double> waiting_on_draw_time_compilation_ms;
    std::optional<double> waiting_on_draw_time_compilation_variation_ms;
    std::optional<double> waiting_on_create_time_compilation_ms;
    std::optional<double> waiting_on_create_time_compilation_variation_ms;
    std::optional<double> in_make_resident_ms;
    std::optional<double> in_make_resident_variation_ms;
    std::optional<double> in_paging_packets_ms;
    std::optional<double> in_paging_packets_variation_ms;
 ...
 private:
  ...
  double waiting_on_queue_sync_variation_ms_;
  double waiting_on_queue_drain_ms_;
  double waiting_on_queue_drain_variation_ms_;
  double waiting_on_fence_ms_;
  double waiting_on_fence_variation_ms_;
  double waiting_on_fence_submission_ms_;
  double waiting_on_fence_submission_variation_ms_;
  double stalled_on_queue_empty_ms_;
  double stalled_on_queue_empty_variation_ms_;
  double between_producer_presents_ms_;
  double between_producer_presents_variation_ms_;
  double between_consumer_presents_ms_;
  double between_consumer_presents_variation_ms_;
  double waiting_on_sync_object_ms_;
  double waiting_on_sync_object_variation_ms_;
  double waiting_on_query_data_ms_;
  double waiting_on_query_data_variation_ms_;
  double waiting_on_draw_time_compilation_ms_;
  double waiting_on_draw_time_compilation_variation_ms_;
  double waiting_on_create_time_compilation_ms_;
  double waiting_on_create_time_compilation_variation_ms_;
  double in_make_resident_ms_;
  double in_make_resident_variation_ms_;
  double in_paging_packets_ms_;
  double in_paging_packets_variation_ms_;
  ...
  double vram_read_bw_gbps_;
  double vram_read_bw_variation_gbps_;
  double vram_write_bw_gbps_;
  double vram_write_bw_variation_gbps_;
  double vram_temp_c_;
