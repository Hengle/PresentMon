...
class Streamer {
 public:
  ...
  void ProcessPresentEvent(PresentEvent* present_event,
                           ...
                           uint64_t last_producer_present_qpc,
                           uint64_t last_consumer_present_qpc,
                           std::string app_name);

  void WriteFrameData(uint32_t process_id, PmNsmFrameData* data);
