...
namespace p2c::gfx
{
	Graphics::Graphics(HWND hWnd)
	{
...

        {
            ...
            dims = { rect.right - rect.left, rect.bottom - rect.top };
    ...
    void Graphics::EndFrame()
    {
        ...
        p2chrlog << pSwapChain->Present(1, 0);
    }
    ...
    void Graphics::Resize(DimensionsI dimensions)
    {
        ...
        pSwapChain->ResizeBuffers(2, dimensions.width, dimensions.height, DXGI_FORMAT_UNKNOWN, 0);
        CreateBackbufferDependentResources_();
        dims = dimensions;
