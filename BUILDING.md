...
5. Download IPF Core SDK:

    - Download IPF-CoreSDK-1.0.11400.36488.zip from here: https://wiki.ith.intel.com/display/ITSIPF/IPF+Releases

    - Unzip it to any directory (e.g., build/IPF), and create an environment variable `IPF_SDK_PATH` that points to
      the directory.  You need to do this before starting visual studio PresentMon2.sln.
