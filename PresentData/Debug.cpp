...
#define FLUSH_MEMBER(_Fn, _Name) \
    ...
    FLUSH_MEMBER(PrintTimeDelta,     INTC_QueueTimers[INTC_TIMER_WAIT_IF_FULL])
    FLUSH_MEMBER(PrintTimeDelta,     INTC_QueueTimers[INTC_TIMER_WAIT_IF_EMPTY])
    FLUSH_MEMBER(PrintTimeDelta,     INTC_QueueTimers[INTC_TIMER_WAIT_UNTIL_EMPTY_SYNC])
    FLUSH_MEMBER(PrintTimeDelta,     INTC_QueueTimers[INTC_TIMER_WAIT_UNTIL_EMPTY_DRAIN])
    FLUSH_MEMBER(PrintTimeDelta,     INTC_QueueTimers[INTC_TIMER_WAIT_FOR_FENCE])
    FLUSH_MEMBER(PrintTimeDelta,     INTC_QueueTimers[INTC_TIMER_WAIT_UNTIL_FENCE_SUBMITTED])
    FLUSH_MEMBER(PrintTimeDelta,     INTC_QueueTimers[INTC_TIMER_SYNC_TYPE_WAIT_SYNC_OBJECT_CPU])
    FLUSH_MEMBER(PrintTimeDelta,     INTC_QueueTimers[INTC_TIMER_SYNC_TYPE_POLL_ON_QUERY_GET_DATA])
