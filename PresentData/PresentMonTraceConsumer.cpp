    ...
    case Intel_Graphics_D3D10::QueueTimers_Info::Id:
    {
        ...
        case Intel_Graphics_D3D10::mTimerType::FRAME_TIME_APP:
        {
            ...
            if (present != nullptr) {
                ...
                //
                // FRAME_TIME_APP gives us an opportunity to fix that, since we
        ...
        case Intel_Graphics_D3D10::mTimerType::FRAME_TIME_DRIVER:
        {
            ...
            // the driver thread (since the present hasn't been submitted yet)
        ...
        case Microsoft_Windows_DxgKrnl::DmaPacket_Info::Id:
        {
            ...
            if (SequenceId != 0) {
                ...
                if (cloudStreamingProcessId != 0) {
                    ...
                    videoPresent->PresentStartTime = *(uint64_t*) &hdr.TimeStamp;
                    videoPresent->ProcessId = hdr.ProcessId;
