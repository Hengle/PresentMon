...
//     parameters: --no_event_structs --event=TokenCompositionSurfaceObject::Info --event=TokenStateChanged::Info --event=InputDeviceRead::Stop --event=RetrieveInputMessage::Info --provider=Microsoft-Windows-Win32k
#pragma once
...
EVENT_DESCRIPTOR_DECL(RetrieveInputMessage_Info         , 0x003f, 0x00, 0x15, 0x04, 0x00, 0x0043, 0x0400000040400000)
