...
//     version:    feature/FirstLevelAnalysisIntegration 393c2bcfe6961bfcfeb6ad01fd0c29e02917274a
//     parameters: --no_event_structs --event=AdapterAllocation::Start --event=AdapterAllocation::Stop --event=AdapterAllocation::DCStart --event=Blit::Info --event=Flip::Info --event=FlipMultiPlaneOverlay::Info --event=IndependentFlip::Info --event=HSyncDPCMultiPlane::Info --event=VSyncDPCMultiPlane::Info --event=MMIOFlip::Info --event=MMIOFlipMultiPlaneOverlay::Info --event=Present::Info --event=PresentHistory::Start --event=PresentHistory::Info --event=PresentHistoryDetailed::Start --event=QueuePacket::Start --event=QueuePacket::Stop --event=VSyncDPC::Info --event=Context::DCStart --event=Context::Start --event=Context::Stop --event=NodeMetadata::Info --event=Device::DCStart --event=Device::Start --event=Device::Stop --event=DmaPacket::Start --event=DmaPacket::Info --event=MakeResident::Start --event=MakeResident::Stop --event=PagingQueuePacket::Start --event=PagingQueuePacket::Info --event=PagingQueuePacket::Stop --provider=Microsoft-Windows-DxgKrnl
#pragma once
...
EVENT_DESCRIPTOR_DECL(PagingQueuePacket_Start_2     , 0x0143, 0x01, 0x11, 0x00, 0x01, 0x00b2, 0x4000000000000001)
