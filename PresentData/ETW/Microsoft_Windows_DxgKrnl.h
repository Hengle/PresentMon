...
//     version:    main 680d93279711620496f13e41c397ec2b72cbfb21
//     parameters: --no_event_structs --event=AdapterAllocation::Start --event=AdapterAllocation::Stop --event=AdapterAllocation::DCStart --event=Blit::Info --event=Flip::Info --event=FlipMultiPlaneOverlay::Info --event=IndependentFlip::Info --event=HSyncDPCMultiPlane::Info --event=VSyncDPCMultiPlane::Info --event=MMIOFlip::Info --event=MMIOFlipMultiPlaneOverlay::Info --event=Present::Info --event=PresentHistory::Start --event=PresentHistory::Info --event=PresentHistoryDetailed::Start --event=QueuePacket::Start --event=QueuePacket::Stop --event=VSyncDPC::Info --event=Context::DCStart --event=Context::Start --event=Context::Stop --event=HwQueue::DCStart --event=HwQueue::Start --event=HwQueue::Stop --event=NodeMetadata::Info --event=Device::DCStart --event=Device::Start --event=Device::Stop --event=DmaPacket::Start --event=DmaPacket::Info --event=MakeResident::Start --event=MakeResident::Stop --event=PagingQueuePacket::Start --event=PagingQueuePacket::Info --event=PagingQueuePacket::Stop --provider=Microsoft-Windows-DxgKrnl
#pragma once
