...
//     version:    main 01bead1649a58ee92251725d823ff941c5e46063
//     parameters: --no_event_structs --event=AdapterAllocation::Start --event=AdapterAllocation::Stop --event=AdapterAllocation::DCStart --event=Blit::Info --event=Flip::Info --event=FlipMultiPlaneOverlay::Info --event=IndependentFlip::Info --event=HSyncDPCMultiPlane::Info --event=VSyncDPCMultiPlane::Info --event=MMIOFlip::Info --event=MMIOFlipMultiPlaneOverlay::Info --event=Present::Info --event=PresentHistory::Start --event=PresentHistory::Info --event=PresentHistoryDetailed::Start --event=QueuePacket::Start --event=QueuePacket::Stop --event=VSyncDPC::Info --event=Context::DCStart --event=Context::Start --event=Context::Stop --event=NodeMetadata::Info --event=Device::DCStart --event=Device::Start --event=Device::Stop --event=DmaPacket::Start --event=DmaPacket::Info --provider=Microsoft-Windows-DxgKrnl
#pragma once
